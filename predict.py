...
def parse_args():
    ...
    parser.add_argument('--enet-type', type=str, default="tf_efficientnet_b4_ns")#'efficientnet_b3'
    parser.add_argument('--kernel-type', type=str,
                        default="tf_efficientnet_b4_ns_size512_outdim9_usemeta_batch16_epoch15_cc12")  # 模型name， same in train
    parser.add_argument('--data-dir-2019', type=str, default='/home/data/ISIC_512/ISIC2019/')
    parser.add_argument('--data-dir-2020', type=str, default='/home/data/ISIC_512/ISIC2020/')
    parser.add_argument('--data-dir-2018', type=str, default='/home/data/ISIC_512/ISIC2018_Task3/')
    # parser.add_argument('--meta_model', type=int, default=0)  # 0:向量拼接  1:向量加权
